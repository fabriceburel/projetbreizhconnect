...
<div class="container grey lighten-2 z-depth-5" id="viewProfile">
    ...
    <div class="row">
        <div class="col offset-l4" id="profile">
            ...
            <h3>Age : <span><?= $user->age ?> ans</span></h3>
            <form action="#" method="POST">
                <button class="btn white black-text" title="Modifier" name="edit" id="editProfile" userId="<?= $users->id ?>">Modification<i class="material-icons">edit</i></button>
                <button data-target="deleteProfile" type="submit" class="btn black modal-trigger" name="delete" title="supprimer">Suppression<i class="material-icons">delete_forever</i></button>
